...
class Parameters:
    def __init__(self):
        ...
        self.scene = [ObjectsLib.add_sphere([.75, .1, 1.], .6, [0., 0., 1.]),
                      ObjectsLib.add_sphere([-.75, .1, 2.25], .6, [.5, .223, .5]),
                      ObjectsLib.add_sphere([-2.75, .1, 3.5], .6, [1., .572, .184]),
                      ObjectsLib.add_plane([0., -.5, 0.], [0., 1., 0.],self.color_plane0, self.color_plane1),
                    ]
