...
scene = [add_tetrahedron([2,.1,2.25],[3,.1,2.25],[2.5,.1,3],[2.5,1.1,2.5],[0., 0., 1.]),
         add_cube([0, -0.5, 2], [.3, .2, .1], [.1, 0, -.3], [-.6, 1, -.2], [0., 0., 1.]),
